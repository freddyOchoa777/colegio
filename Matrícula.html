...
<!-- ..................................................... ............-->
	...
	<div id="inicio">	
		...
		<!-- iMAGEN DEL BANNER CENTRADA-->
			...
			<div class="logo">
							<center><img src="img/Noticias/Logo_San_José_de_Cafasso.png" height="100px"></center>
			</div>
	</div>
			...
			<h1>Datos Personales del Estudiante:</h1>  
				...
				<form>
					<center>
							<table>
									  <tr>
									  <td>Primer Nombre:</td><td> <input type="text"><br></td>
									  </tr>
                                      <tr>
                                        <td>Segundo Nombre:</td><td> <input type="text"><br></td>
                                        </tr>
										  <tr>
										  <td>Pimer Apellido:</td><td><input type="text" ></td>
										  </tr>
                                          <tr>
                                            <td>Segundo Apellido:</td><td> <input type="text"><br></td>
                                            </tr>
									  <tr>
                                      ...
                                      <tr>
                                        ...
                                        <tr>
										  ...
										  <tr>
										  <td>Barrio:</td><td><input type="text" ></td>
										  </tr>
                                          <tr>
									  ...
									  <tr>
									  <td>Nombre del Colegio o Jardin de procedencia :</td><td><input type="text" ></td>
									  </tr>
                                      <tr>
                                        ...
                                        <tr>
										  ...
										  <tr>
										  <td>EPS:</td><td><input type="text" ></td>
										  </tr> 
                                      ...
                                      <tr>
                                        ...
                                        <tr>
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                                <td>Hermanos en la Institucion:</td><td><input type="text" ></td>
                                                </tr> 
                ...
                <hr>
                   <form>
                              ...
                              <table>
                                ...
                                <tr>
                                    <td>Enfermedades actuales:</td><td><input type="text" ></td>
                                    </tr>

                                    <tr>
                                    <td>¿El estudiante toma algún medicamento de manera permanente?*
                                        Escriba Si o No. De escribir Si, especifique cuál:</td><td> <input type="text"><br></td>
                                    </tr>
				...
				<form>
							<table>
                                      ...
                                      <td>Direccion:</td><td><input type="text" ></td>
                                          ...
                                          <tr>
                                          <td>Correo electronico:</td><td><input type="text" ></td>
                                          </tr>
									  <tr>
									  <td>Telefono celular:</td><td><input type="text" ></td>
									  </tr>
                                       
                                      <tr>
                                        <td>Telefono fijo:</td><td><input type="text" ></td>
                                        </tr>
										  <tr>
										  <td>Profesion:</td><td><input type="text" ></td>
										  </tr>
										  <tr>
									  <td>Empresa donde trabaja:</td><td> <input type="text"><br></td>
									  </tr>
										  <tr>
										  <td>Cargo que ocupa en la empresa:</td><td><input type="text" ></td>
										  </tr>
									  <tr>
									  <td>Telefono de la empresa:</td><td><input type="text" ></td>
									  </tr>
										  <tr>
										  <td>Direccion de empresa:</td><td><input type="text" ></td>
										  </tr>
									  <tr>
									  <td>Estado Civil:</td>
										  <td>
